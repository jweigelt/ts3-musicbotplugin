...
private:
	string onSeek = "Seeking to %u:%u:%u...";
	string onNotPlaying = "Can't seek: no playback running";
	string onNotSeekable = "Can't seek: current mediasource is not seekable.";
	string onInvalidTimestamp = "Invalid timestamp. Valid format: hour:min:sec.";
};