...
ConfigException::ConfigException(const char * message, SI_Error siCode) : runtime_error(message)
{
	this->message = message;
	this->siCode = siCode;
}

ConfigException::ConfigException(const char * message) : runtime_error(message)
{
	this->message = message;
}
